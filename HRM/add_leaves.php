                                    ...
                                    <div class="col-lg-12" style="margin-top: 16px;">
                                        <div class="card">
                                            <div class="form-group">
                                                <div class="card-header"><strong>Add Leaves details</strong></div>
...
if (isset($_POST["submit1"])) {
    ...
    mysqli_query($link, "insert into leaves values(NULL,'$_POST[name]','$_POST[depatment]','$_POST[startleave]','$_POST[endleave]','$_POST[reason]','$days_between','$Requested','$username')") or die(mysqli_error($link));
}
?>
<script type="text/javascript">
    alert {
